...
serve(async (req) => {
  ...
  try {
    ...
    // Use OpenAI to analyze and suggest the best match
    ...
    const aiResponse = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        model: 'gpt-4o-mini',
        messages: [
          { role: 'system', content: 'You are a helpful assistant that analyzes traffic fines and rental agreements to find the best matches. Always return valid JSON.' },
